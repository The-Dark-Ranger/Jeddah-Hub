...
export default function ActivitiesPage() {
  ...
  function openEdit(a: Activity) {
    setEditing(a);
    setForm({ title: a.title, eyebrow: a.eyebrow, subtitle: a.subtitle, description: a.description,
              date: a.date, location: a.location, ctaText: a.ctaText, ctaUrl: a.ctaUrl,
              highlights: a.highlights, active: a.active });
          ...
          {activities.map(a => (
            <div key={a.id} className={styles.card + (a.active ? ' ' + styles.cardActive : '')}>
              ...
              <div className={styles.cardActions}>
                ...
                >
                  {a.active ? t('activityInactive') : t('activityActive')}
                </button>
